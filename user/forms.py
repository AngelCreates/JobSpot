...
class ApplicantAddResumeForm(ModelForm):
    resume = forms.FileField(required=False, error_messages={
                             'invalid': "Pdf files only"}, widget=forms.FileInput)
