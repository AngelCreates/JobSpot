...
class WorkExperienceModel(models.Model):
    ...
    job_type = models.CharField(
        max_length=30, choices=JOB_TYPE_CHOICES, null=True, blank=True)
...
class SkillSetModel(models.Model):
    ...
    proficiency = models.CharField(
        max_length=255, choices=SKILL_PROFICIENCY, null=True, blank=True)
...
class LanguageModel(models.Model):
    ...
    proficiency = models.CharField(
        max_length=30, choices=SKILL_PROFICIENCY, null=True, blank=True)
...
class RatingModel(models.Model):
    company = models.ForeignKey(
        CompanyProfileModel, null=True, blank=True, on_delete=models.CASCADE)
...
class ProfileViewDetails(models.Model):
    viewedBy = models.ForeignKey(
        User, related_name='viewedBy', on_delete=models.CASCADE)
    viewed = models.ForeignKey(
        User, related_name='viewed', on_delete=models.CASCADE)
