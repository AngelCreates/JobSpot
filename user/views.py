...
def company_profile(request, pk):
    ...
    if employee_search is not None:
        ...
        employee_list = PreferredJobModel.objects.filter(
            Q(details__icontains=employee_search))
